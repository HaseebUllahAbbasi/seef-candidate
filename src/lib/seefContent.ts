...
export const DEMO_SCHOLARSHIPS = [
  {
    ...
    regNo: `SEEF/${new Date().getFullYear()}/01`,
    minCgpa: 2.2,
    province: 'Sindh',
    endDate: `${new Date().getFullYear()}-12-31`,
    status: 'PUBLISHED',
    eligibleCriteria: 'Sindh domicile students in HEC-recognized universities with minimum CGPA 2.2.',
    programs: [
  ...
  },
  {
    ...
    year: new Date().getFullYear(),
    regNo: `SEEF/${new Date().getFullYear()}/02`,
    minCgpa: 2.2,
    province: 'Sindh',
    endDate: `${new Date().getFullYear()}-09-30`,
    status: 'PUBLISHED',
    eligibleCriteria: 'Need-based support for Sindh students from low-income families enrolled in public universities.',
    programs: [
